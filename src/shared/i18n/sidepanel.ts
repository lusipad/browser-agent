...
export const sidepanelDict = {
  ...
  'skill.editMode': { zh: '编辑', en: 'Edit' },
  'skill.runMode': { zh: '运行', en: 'Run' },
  'skill.editSkill': { zh: '编辑技能', en: 'Edit Skill' },
  'skill.saveChanges': { zh: '保存修改', en: 'Save Changes' },
  'skill.cancelEdit': { zh: '取消', en: 'Cancel' },
  'skill.savedToast': { zh: '✓ 已保存修改', en: '✓ Changes saved' },
  'skill.openInOptions': { zh: '在设置中打开 ↗', en: 'Open in Settings ↗' },
  'skill.basicInfo': { zh: '基本信息', en: 'Basic Info' },
  'skill.name': { zh: '技能名称', en: 'Skill Name' },
  'skill.desc': { zh: '技能描述', en: 'Description' },
  'skill.icon': { zh: '图标 (Emoji)', en: 'Icon' },
  'skill.steps': { zh: '步骤清单', en: 'Steps' },
  'skill.addStep': { zh: '＋ 添加步骤', en: '＋ Add Step' },
  'skill.stepIntent': { zh: '操作意图 (支持 {{变量名}})', en: 'Intent (supports {{var}})' },
  'skill.stepUrl': { zh: '导航 URL (可选)', en: 'URL (optional)' },
  'skill.stepNote': { zh: '备注条件 (可选)', en: 'Note (optional)' },
  'skill.vars': { zh: '参数变量', en: 'Variables' },
  'skill.addVar': { zh: '＋ 添加参数', en: '＋ Add Parameter' },
  'skill.varName': { zh: '变量名 (英文)', en: 'Key' },
  'skill.varLabel': { zh: '显示名称', en: 'Label' },
  'skill.varDefault': { zh: '默认值', en: 'Default' },
  'skill.varType': { zh: '类型', en: 'Type' },
  'skill.typeString': { zh: '文本 (string)', en: 'string' },
  'skill.typeNumber': { zh: '数字 (number)', en: 'number' },
  'skill.typeBoolean': { zh: '开关 (boolean)', en: 'boolean' },
  'skill.scheduleSection': { zh: '⏰ 定时调度与自动化', en: '⏰ Schedule' },
  'skill.enableSchedule': { zh: '启用定时执行', en: 'Enable schedule' },
  'skill.frequency': { zh: '执行频次', en: 'Frequency' },
  'skill.dailyTime': { zh: '每日时间点', en: 'Daily time' },
  // 工具名
