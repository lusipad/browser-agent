...
export const DEFAULT_CONFIG: AppConfig = {
  ...
  models: [
    ...
    { id: 'deepseek-flash', label: 'DeepSeek Flash（V4.1·原生视觉）', vision: true, contextWindow: 1000000 },
    { id: 'deepseek-pro', label: 'DeepSeek Pro', vision: false, contextWindow: 1000000 },
  ...
  bindings: [
    ...
    { id: 'deepseek/deepseek-flash', modelId: 'deepseek-flash', providerId: 'deepseek', apiModelName: 'deepseek-flash', pricing: { input: 0.15, output: 0.6 }, enabled: true },
    { id: 'deepseek/deepseek-pro', modelId: 'deepseek-pro', providerId: 'deepseek', apiModelName: 'deepseek-pro', pricing: { input: 0.28, output: 1.1 }, enabled: true },
