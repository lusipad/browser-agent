...
export const DEFAULT_CONFIG: AppConfig = {
  ...
  models: [
    ...
    { id: 'deepseek-v4-flash', label: 'DeepSeek V4 Flash（无视觉）', vision: false, contextWindow: 128000 },
    { id: 'deepseek-v4-pro', label: 'DeepSeek V4 Pro（无视觉）', vision: false, contextWindow: 128000 },
  ...
  bindings: [
    ...
    { id: 'deepseek/deepseek-v4-flash', modelId: 'deepseek-v4-flash', providerId: 'deepseek', apiModelName: 'deepseek-v4-flash', pricing: { input: 0.14, output: 0.28 }, enabled: true },
    { id: 'deepseek/deepseek-v4-pro', modelId: 'deepseek-v4-pro', providerId: 'deepseek', apiModelName: 'deepseek-v4-pro', pricing: { input: 0.28, output: 1.1 }, enabled: true },
